...
/* NEW: chat bubble text was invisible (white-on-white) under a dark
   Streamlit theme - the bubble background was forced white above but
   nothing forced the text color, so it inherited the dark-theme's
   light text color. This fixes just the chat message content. */
